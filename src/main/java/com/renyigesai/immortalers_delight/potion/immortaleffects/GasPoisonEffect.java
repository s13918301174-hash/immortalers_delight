...
//    private MobEffect THIS_EFFECT = ImmortalersDelightMobEffect.GAS_POISON;
//
...
//        MobEffectInstance effectInstance = new MobEffectInstance(ImmortalersDelightMobEffect.GAS_POISON, (int) (durationSeconds *20), amplifier);
...
//         */
////        if (!entity.hasEffect(ImmortalersDelightMobEffect.GAS_POISON)) {
////            removeImmortalEffect(entity);
////        }
//        /*
...
//            MobEffectInstance newOne = new MobEffectInstance(ImmortalersDelightMobEffect.GAS_POISON,durationTicks ,amplifier);
//            entity.addEffect(newOne);
//            return;
//        }
//        int lv = Objects.requireNonNull(entity.getEffect(ImmortalersDelightMobEffect.GAS_POISON)).getAmplifier();
//        int time = Objects.requireNonNull(entity.getEffect(ImmortalersDelightMobEffect.GAS_POISON)).getDuration();
...
//         */
//        entity.removeEffect(ImmortalersDelightMobEffect.GAS_POISON);
